...
function NewsDetail() {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://kstraining-server.vercel.app/api/news/all"
        );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(
          `https://kstraining-server.vercel.app/api/news/single/${blogId}`
        );
        const data = await response.json();
        setBlog(data.data);
      } catch (error) {
          ...
          <div className="footer-top">
            <div className="f1">
              ...
              <p>
                ...
                regeneration of nature. We enable companies to gift trees that
                are brought back in the heart of Africa. Easily, at scale, and
                with an epic customizable gifting experience.
              </p>
              <br />
